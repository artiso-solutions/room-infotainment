...
function getTemperature(cityId) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.get("http://api.openweathermap.org/data/2.5/weather?id=" + cityId + "&APPID=" + API_KEY + "&units=metric")];
                case 1:
                    resp = _a.sent();
                    if (!resp.data)
                        return [2 /*return*/, 0];
...
app.get("/temperature/:cityId", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, getTemperature(req.params.cityId)];
            case 1:
                temparature = _a.sent();
